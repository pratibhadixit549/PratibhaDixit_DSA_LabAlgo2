package payMoney_DailyTarget_01;
...
public class DailyTargetDeterminator {
	...
	void determine(Integer dailyTarget) {
		...
		/*
		 * overallTransactionSum int counter = 0; for (... )
		 * 
		 * counter ++ Retreive transactionnValue
		 * 
		 * overallTransactionSum = overallTransactionSum + transactionnValue
		 * 
		 * overallTransactionSum >= DailyTarget break;
		 * 
		 * outcome -> true Success -> false Not achieved
		 * 
		 * 
		 */
	}
